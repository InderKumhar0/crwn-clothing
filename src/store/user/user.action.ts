...
import { ActionWithPayload, createAction, Action, withMatcher } from "../../utils/reducer/reducer.utils";
...
export type SignUpSuccess = ActionWithPayload<USER_ACTION_TYPES.SIGN_UP_SUCCESS, { user: string, additionalDetails: AdditionalInformation }>
...
export const signUpSuccess = withMatcher((user: string, additionalDetails: AdditionalInformation): SignUpSuccess =>
